...
export class Controller {
     ...
     */
    tick(target_x, target_y) {
        wasm.controller_tick(this.__wbg_ptr, target_x, target_y);
    }
    /**
     * @returns {number}
     */
    width() {
        const ret = wasm.controller_height(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @returns {number}
     ...
     */
    num_boids() {
        const ret = wasm.controller_num_boids(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @returns {number}
     */
    boids() {
        const ret = wasm.controller_boids(this.__wbg_ptr);
        return ret >>> 0;
    }
}
