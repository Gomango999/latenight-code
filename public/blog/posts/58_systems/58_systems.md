...
Systems are great for a many reasons. As we've talked about before, systems are a rock solid fallback that you can always rely on to get _some_ results. The goal is not for your system to represent what your top performance looks like. Instead, on the days that you feel that you are underperforming, the system gives you something that you can always anchor yourself on to get a guranteed 60-70% of the results. Even seemingly abstract concepts, like "coming up with an idea for an illustration" can be systemised.
